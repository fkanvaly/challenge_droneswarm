...
void DroneSimpleController::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  cmd_normal_topic_ = "/"+drone_name_+"/cmd_vel";
  takeoff_topic_ = "/"+drone_name_+"/takeoff";
  land_topic_ = "/"+drone_name_+"/land";
  reset_topic_ = "/"+drone_name_+"/reset";
  posctrl_topic_ = "/"+drone_name_+"/posctrl";
  gt_topic_ = "/"+drone_name_+"/gt_pose";
  switch_mode_topic_ = "/"+drone_name_+"/vel_mode";
  ...
  if (!gt_topic_.empty()){
      pub_gt_pose_ = node_handle_->advertise<geometry_msgs::Pose>("/"+drone_name_+"/gt_pose",1024);    
  }
  
  pub_gt_vec_ = node_handle_->advertise<geometry_msgs::Twist>("/"+drone_name_+"/gt_vel", 1024);
  pub_gt_acc_ = node_handle_->advertise<geometry_msgs::Twist>("/"+drone_name_+"/gt_acc", 1024);
